...
String charLookup = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\xe6\xf8\xe5\xc6\xd8\xc5";

// Defines all characters in the lookup string
// First byte is width of font, rest is padded with 0-bytes
unsigned char PROGMEM font_variable[101][8] = {
    ...
    {5,0x01,0x01,0x79,0x05,0x03,0x00,0x00}, // 7
    {5,0x36,0x49,0x49,0x49,0x36,0x00,0x00}, // 8
    {5,0x06,0x49,0x49,0x49,0x3e,0x00,0x00}, // 9
